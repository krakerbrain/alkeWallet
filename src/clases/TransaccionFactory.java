...
public class TransaccionFactory {
    ...
    /**
     * Método para obtener una instancia de una operación bancaria basada en la opción dada por el usuario.
     *
     * @param cuenta Instancia de la cuenta sobre la cual se realizará la operación.
     * @param opcion Opción seleccionada por el usuario para determinar el tipo de operación.
     * @return Instancia de la operación correspondiente o null si la opción es inválida.
     */
