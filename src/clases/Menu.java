...
public class Menu {
    ...
    // Método para obtener la opción seleccionada por el usuario después de una transacción exitosa
    ...
    // Método para mostrar el mensaje de transacción exitosa y obtener la opción del usuario
    ...
    // Otro método para mostrar un mensaje de transacción exitosa (en el caso de transferencias) y obtener la opción del usuario
    ...
    // Método para obtener la opción seleccionada por el usuario después de ver los datos de la cuenta
    public byte transaccionExitosaVerDatos() {
        // Obtener la opción seleccionada por el usuario después de ver los datos de la cuenta
        return pieTransaccionExitosa();
    }

    // Método para mostrar el menú de conversión de monedas y obtener la opción del usuario
    public double menuTipoConversion() {
        ...
        if (opcion == 1) {
            ...
            // Si el usuario elige volver al menú inicial, permitirle seleccionar otra operación
    ...
    // Método para solicitar al usuario el monto de una operación (depósito, retiro, etc.)
